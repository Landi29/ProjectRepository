...
namespace JaccardSimilarityLibrary
{
    public class JaccardSimilarity 
    {
        ...
        private decimal CalculateSimilarity()
        {
            ...
            SimilarElements = shinglesA.Intersect(shinglesB); // Gets the Intersections of the two HashSets with shingles  

            AllElements = shinglesA.Union(shinglesB); // Gets the Union of the two HashSets with shingles  
